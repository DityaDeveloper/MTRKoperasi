...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference("ANGGOTAKOPERASI");
        geoFire = new GeoFire(ref);

        toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("M-TR Koperasi");
                        ...
                        sv.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                            ...
                            public boolean onQueryTextSubmit(String query) {
                                ...
                                if (str != null) {
                                    ...
                                    Toast.makeText(MapsActivity.this, "Parameter jarak kosong!", Toast.LENGTH_SHORT).show();
                                }
                                return true;
                            }
    ...
    private void removegeofence() {
        ...
        if (circle != null) {
            ...
            alertDialog.setTitle("M-TR Koperasi").setIcon(R.drawable.icon);
            alertDialog.setMessage("Area Koperasi Dihapus.").setPositiveButton("OK", null);
            alertDialog.show();
        } else {
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(MapsActivity.this);
            alertDialog.setTitle("M-TR Koperasi").setIcon(R.drawable.icon);
            alertDialog.setMessage("Tidak Ada Area Koperasi.").setPositiveButton("OK", null);
            alertDialog.show();
        }
    }
    ...
    private void creategeofence() {
        ...
        if (mLastLocation != null && flag) {
            ...
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(MapsActivity.this);
            alertDialog.setTitle("M-TR Koperasi").setIcon(R.drawable.icon);
            alertDialog.setMessage("Area Koperasi Ditambahkan.").setPositiveButton("OK", null);
            alertDialog.show();
            //Add GeoQuery here
            ...
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(MapsActivity.this);
            alertDialog.setTitle("M-TR Koperasi").setIcon(R.drawable.icon);
            alertDialog.setMessage("Mohon Hapus Area Lama.").setPositiveButton("OK", null);
            alertDialog.show();
        }
    }
    private void searchLocation(String location) {
        if (location != null) {
            ...
            if (list.size() > 0) {
                ...
                Toast.makeText(MapsActivity.this, "Tidak Ada Area: " + location, Toast.LENGTH_LONG).show();
            }
        } else {
    ...
    private void GeoQueryFunction(final LatLng area) {
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                sendNotification("Anggota Koperasi", String.format("%s Telah Tiba di Area Koperasi", key));
                SmsManager.getDefault().sendTextMessage(phone_number, null, "Anggota Koperasi tiba di area, bisa di check disini \nhttp://maps.google.com?q=" + area.latitude + "," + area.longitude, null, null);

            }

            @Override
            public void onKeyExited(String key) {
                sendNotification("Anggota Koperasi", String.format("%s Jauh dari Area Koperasi", key));
                SmsManager.getDefault().sendTextMessage(phone_number, null, "Anggota Koperasi Jauh dari area, bisa di check disini \nhttp://maps.google.com?q=" + area.latitude + "," + area.longitude, null, null);
            }

            @Override
            public void onKeyMoved(String key, GeoLocation location) {
                Log.d("Sedang Berjalan", String.format("%s Sedang berjalan ke Area Koperasi [%f/%f]", key, location.longitude, location.longitude));
            }
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            ...
            final double longitude = mLastLocation.getLongitude();
            //Update To Firebase
            geoFire.setLocation("Kamu", new GeoLocation(latitude, longitude), new GeoFire.CompletionListener() {
                @Override
            ...
            Log.d("M-TR Koperasi", String.format("Lokasi telah berubah %f/ %f", latitude, longitude));
        } else
            Log.d("M-TR Koperasi", "Lokasi diluar jangkauan");
    }
